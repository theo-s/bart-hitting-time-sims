...
for (dgp_name in c("linear_add", "smooth_add")) {
  ...
  res <- read.csv(paste0("results/cached_results/exp1_dgp_",dgp_name,"_components_analysis.csv"))
  ...
  ggsave(plot_i,filename = paste0("results/figures/exp1/",dgp_name,"components_rmse.pdf"), height = 2.5, width = 3)
...
p_final = grid.arrange(all_plots[[1]]+theme(legend.position ="none"),
                       ...
                       widths = c(4,4.75),
                       ncol = 2)
ggsave(p_final,filename = paste0("results/figures/exp1/all_components_rmse.pdf"), height = 2.5, width = 8)
...
for (dgp_name in c("linear_add", "smooth_add")) {
  ...
  ggsave(plot_i,filename = paste0("results/figures/exp1/",dgp_name,"components_coverage.pdf"), height = 2.5, width = 3)
  all_plots[[idx]] = plot_i
  idx = idx + 1
}
...
p_final = grid.arrange(all_plots[[1]]+theme(legend.position ="none"),
                       ...
                       widths = c(4,4.75),
                       ncol = 2)
ggsave(p_final,filename = paste0("results/figures/exp1/all_components_coverage.pdf"), height = 2.5, width = 8)
